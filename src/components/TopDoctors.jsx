...
const TopDoctors = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
            ...
            {/* <button onClick={()=>{navigate('/doctors'); scrollTo(0,0) }} className='bg-[#A0AAFD] text-gray-800 px-12 py-3 rounded-full mt-10 hover:bg-primary hover:text-white'>more</button> */}
            <button onClick={()=>{navigate('/doctors'); scrollTo(0,0) }} className='bg-primary text-white px-12 py-3 rounded-full mt-10 hover:bg-[#A0AAFD] hover:text-white hover:scale-110 transition-all'>more</button>
        </div>
    )
}
